...
def mesh_render(model, material, scale=1.0, rotate=True, shadows=False, morphs=(), shader=(), particle_attrs=True, scale_param=None, part_from_particle=False):
    ...
    return mod("MeshRenderModule", "Render", "Mesh", Model=model, Material=material, Scale=fb(scale, scale_param), RotateWithObject=rotate, CastShadows=shadows,
               ...
               Shader=[{"Enabled": True, "Name": n, "Width": w, "Value": (b if w < 3 else fb(0)), "Color": (b if w >= 3 else cb()), "Min": 0, "Max": 1} for n, w, b in shader],
...
effect("firework_burst", [
    emitter("Stars",
        ...
        drag(1.1),
        sprite_render("spark", additive=True, face=True),
        trail_render(width=0.05, color=gradient([(0, hexc("ffffff", 0.9)), (1, hexc("ff8040", 0.0))]), life=0.45, max_points=24, point_distance=0.06),
...
effect("firework_chain", [
    emitter("Rocket",
        ...
        gravity(0, -9.8, 0),
        sprite_render("spark", additive=True, face=True),
        trail_render(width=0.08, color=gradient([(0, hexc("ffd8a0", 0.9)), (1, hexc("ff6020", 0.0))]), life=0.6, max_points=40, point_distance=0.08),
...
effect("meteor", [
    emitter("Rock",
        ...
        trail_render(width=0.35, color=gradient([(0, hexc("ffd090", 0.8)), (0.5, hexc("ff6020", 0.5)), (1, hexc("401000", 0.0))]),
...
def planet(name, shape_name, speed, colour, radius_m, phase=0.0):
    return emitter(name,
        ...
        trail_render(width=0.5, color=hexc("ffffff", 0.35), life=0.9, max_points=60, point_distance=0.04, scale_from=True, tint=True),
...
effect("sparkler", [
    emitter("Sparks",
        ...
        drag(0.6),
        sprite_render("spark", additive=True, face=True),
        trail_render(width=0.03, color=gradient([(0, hexc("ffffff", 0.9)), (0.5, hexc("ffc060", 0.5)), (1, hexc("ff6020", 0.0))]),
...
effect("chain_burst", [
    emitter("Sparks",
        ...
        sprite_render("spark", additive=True, face=True),
        trail_render(width=0.02, color=hexc("ffffff"), life=0.25, max_points=16, point_distance=0.03, scale_from=False, tint=True),
        max_particles=40),
    emitter("Flash",
        burst(1),
        position("Point"),
...
effect("chain_rocket", [
    emitter("Rockets",
        ...
        sprite_render("glow", additive=True),
        trail_render(width=0.04, color=hexc("ffffff"), life=0.4, max_points=32, point_distance=0.03, scale_from=False, tint=True),
        max_particles=8),
], duration=4.0, looping=True,
